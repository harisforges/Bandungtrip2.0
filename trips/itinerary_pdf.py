...
h2 { font-size:11.5pt; margin:7px 0 4px; padding-bottom:4px; border-bottom:2px solid #15764F; color:#15764F; }
...
.sum td { padding:3px 7px; border:1px solid #CFCFC6; font-size:8.8pt; vertical-align:top; }
.sum td.d { font-weight:700; white-space:nowrap; }
.sum tr:nth-child(even) td { background:#FAFAF7; }

.notebox { border:1px solid #E3C7A6; background:#FDF6EC; border-radius:5px; padding:6px 12px; }
.notebox .row { display:flex; gap:9px; padding:1.5px 0; }
...
.sign { margin-top:6px; border:1px dashed #B9B9AF; border-radius:5px; padding:6px 12px; font-size:8.2pt; color:#55554E; }
